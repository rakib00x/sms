                ...
                <div class="auth-inner py-2">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <div class="mb-1">
                                <label>Your desktop URL</label>
                                <h3 style="color:green;">{{ URL::to('file-upload-by-apps') }}/{{ $encoded }}</h3>
                            </div>

                            <p>Select all the above url and and copy it then use this url on your desktop or laptop browser to upload contact from csv/txt file.</p>
