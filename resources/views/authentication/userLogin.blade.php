                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <a href="{{route('home')}}" class="brand-logo">
                                ...
                                <h3 class="brand-text text-primary ms-1">Avail Trade SMS Services</h3>
                            </a>

                            <h4 class="card-title mb-1">Provide valid information to access !!</h4>

                            {!! Form::open(['id' => 'signin','method' => 'post','class' => 'auth-login-form mt-2']) !!}
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" name="email" tabindex="1" autofocus />
                                </div>
...
<!-- BEGIN: Page JS-->
<script src="{{URL::to('public/backend/app-assets/js/scripts/pages/page-auth-login.js')}}"></script>
<!-- END: Page JS-->
        ...
        $("#signin").on('submit',function (e) {
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    if(first == "admin"){
                        location.replace("{{ URL::to('admin-dashboard') }}"+"/"+second);
                    }else{
                        swal("E-mail & password does't matched.", { icon: "error" });
                    }
                }
            });
