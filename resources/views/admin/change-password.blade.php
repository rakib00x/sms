                        ...
                        <div class="col-xl-12 col-md-12 col-12">
                            <div class="card card-congratulation-medal">
                                <div class="card-body">
                                    ...
                                    {!! Form::open(['url' => 'update-password', 'method' => 'post', 'class' => 'form form-vertical', 'files'=>'true']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control" name="confirm_new_pass" />
                                            </div>
                                        </div>

                                        <div class="col-12">
                                            <button type="submit" class="btn btn-danger me-1">Change Password</button>
