                            ...
                            <div class="card card-congratulation-medal">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="first-name-vertical">Admin Name</label>
                                                <input type="text" value="{{ $admin_info->name }}" class="form-control" name="full_name" />
                                            </div>
                                        </div>

                                        <div class="col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="first-name-vertical">E-mail Address</label>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" value="{{ $admin_info->phone }}" class="form-control" name="phone" />
                                            </div>
                                        </div>

                                        <div class="col-12">
                                            <div class="mb-1">
                                                <img class="img-fluid" src="{{ URL::to('frontend/admin') }}/{{ Session::get('photo') }}" alt="">
                                            </div>
                                        </div>
