                            ...
                            <div class="card card-congratulation-medal">
                                <div class="card-body">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody id="myTable">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ URL::to('edit-district') }}/{{ $district->id }}" class="btn btn-warning">Edit</a></td>
                                                    <td><a onclick="return confirm('Are you Sure to Delete it ?')"  href="{{ URL::to('delete-district') }}/{{ $district->id }}" class="btn btn-danger">Delete</a></td>
                                                </tr>
                                                @endforeach 
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" type="text" name="ds_name"/>
                                    </div>
...
<script>
        $('[name="country"]').change(function(e){
            ...
            $.ajax({
                ...
                {
                    console.log(data);
                    $('[name="division_id"]').empty();
                    $('[name="division_id"]').html(data);
                },
                error: function(data) {
        ...
        $("#store-district").on('submit',function(e){
            e.preventDefault();

            var division_id = $('[name="division_id"] :selected').val();
            var ds_name = $('[name="ds_name"]').val();
            ...
            $.ajax({
                'url':"{{ url('/store-district') }}",
                'type':'post',
                'dataType':'text',
                data:{division_id:division_id,ds_name:ds_name},
                beforeSend: function() {
                    $('#cover-spin').show(0);
                },
                success:function(data)
