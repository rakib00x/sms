                        ...
                        <div class="col-xl-12 col-md-12 col-12">
                            <div class="card card-congratulation-medal">
                                ...
                                <div class="card-body">
                                    ...
                                    {!! Form::open(['url' =>'updateDivision','method' => 'post','class' => 'form form-vertical', 'files'=>'true']) !!}
                                        ...
                                        <div class="mb-1">
                                           ...
                                           <div class="col-12">
                                                    <div class="mb-1">
                                                      ...
                                                      <?php if($country->id == $row->country_id){echo "selected"; }else{echo "";} ?>>
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <input class="form-control" type="text" name="div_name" value="{{ $row->div_name }}"/>
                                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="submit" value="UPDATE Division" class="btn btn-primary me-1">
                                        </div>
                                    </div>
