                        ...
                        <div class="col-xl-12 col-md-12 col-12">
                            <div class="card card-congratulation-medal">
                                ...
                                <div class="card-body">
                                    ...
                                    {!! Form::open(['url' =>'updateUpzela','method' => 'post','class' => 'form form-vertical', 'files'=>'true']) !!}
                                        ...
                                        <div class="mb-1">
                                           ...
                                           <div class="col-12">
                                                    <div class="mb-1">
                                                      ...
                                                      <?php if($country->id == $row->district_id){echo "selected"; }else{echo "";} ?>>
                                                        <?php echo $country->ds_name ; ?>
                                                             </option>
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <input class="form-control" type="text" name="up_name" value="{{ $row->up_name }}"/>
                                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="submit" value="UPDATE DISTRICT" class="btn btn-primary me-1">
                                        </div>
                                    </div>
