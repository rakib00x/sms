                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Send Group SMS</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12 col-md-12 col-12">
                            <div class="card card-congratulation-medal">
                                <div class="card-body">
                                    ...
                                    {!! Form::open(['id' => 'send-group-sms-by-phone', 'method' => 'post','role' => 'form', 'files'=>'true']) !!}
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            $("#send-group-sms-by-phone").on('submit',function(e){
                e.preventDefault();
                ...
                $.ajax({
                    'url':"{{ url('/send-group-sms-by-phone') }}",
                    'type':'post',
                    'dataType':'text',
                    ...
                    {
                        if(data == "true"){
                           toastr.success('Group Sms Sent Successfully !!', 'Success');
                        }
                    }
                });
