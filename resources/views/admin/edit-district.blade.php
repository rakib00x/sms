                        ...
                        <div class="col-xl-12 col-md-12 col-12">
                            <div class="card card-congratulation-medal">
                                ...
                                <div class="card-body">
                                    ...
                                    {!! Form::open(['url' =>'updateDistrict','method' => 'post','class' => 'form form-vertical', 'files'=>'true']) !!}
                                        ...
                                        <div class="mb-1">
                                           ...
                                           <div class="col-12">
                                                    <div class="mb-1">
                                                      ...
                                                      <?php if($country->id == $row->division_id){echo "selected"; }else{echo "";} ?>>
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <input class="form-control" type="text" name="ds_name" value="{{ $row->ds_name }}"/>
                                                </div>
